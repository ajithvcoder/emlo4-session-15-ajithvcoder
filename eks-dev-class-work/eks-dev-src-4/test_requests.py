...
def load_image() -> bytes:
    """Load the test image"""
    image_path = os.path.join(os.path.dirname(__file__), "dog2.jpg")
...
def make_request(url: str, image_data: bytes) -> Dict:
    ...
    files = {"image": ("dog2.jpg", image_data, "image/jpeg")}
...
# python test_requests.py --rul k8s-default-classifi-18da2b317c-1355353865.ap-south-1.elb.amazonaws.com --requests 1 --workers 1
